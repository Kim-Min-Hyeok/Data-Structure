...
int main(int argc, char *argv[]) {
 ...
 do {
   ...
   case 's': DPRINT(cout << "case = " << option_char << endl;)
     ...
     if(algorithm_chosen == BUBBLE) bubbleSort(list, N);
     if(algorithm_chosen == INSERTION) insertionSort(list, N);
     if(algorithm_chosen == QUICKSORT) quickSort(list, N);
     if(algorithm_chosen == SELECTION) selectionSort(list, N);
